This repository contains the sample code for the blog article at [mattias.engineer/posts/hcp-boundary/]([https://mattias.engineer](https://mattias.engineer/posts/hcp-boundary/)).
